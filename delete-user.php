            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                <li ><a href="index2.html">Home</a></li>
                 <li><a href="blog-archive2.html">Institute</a></li>
                <li><a href="course-archive2.html">Courses</a></li>
                <li><a href="scholarship2.html">Scholarship</a></li>
                <li class="active"><a href="logout.php">Logout</a></li>
                <li><a href="events-archive2.html">Admissions</a></li>
                <li><a href="gallery2.html">Gallery</a></li>
                <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Resources<span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#">NPTEL</a></li>
                    <li><a href="#">Internet Center</a></li>
                    ...
                    <li><a href="#">Online Resources</a></li>
                     <li><a href="#">GNITS Innovation Cell</a></li>
                    <li><a href="#">Sanskrit Education(NFSE)</a></li>
                  </ul>
                </li>
...
<div class="row">
  <div class="col-md-3">
    <div class="list-group">
      ...
      <a href="#" class="list-group-item">Class Notes</a>
