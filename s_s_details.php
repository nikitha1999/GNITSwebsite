...
<div class="card" >
      <div class="card-body" style="background-color:#3498DB;color:#ffffff;margin-top: 25px; height: 40px;">
          <label style="margin-top:10px;margin-left: 20px; ">Student Details</label>
      </div>
...
<div class="card-body">
        ...
        <label style="margin-top:5px;margin-left: 20px;">Father's Name:</label>
          <?php echo "{$_SESSION['s_f_name']}"?>
        </br>
         <label style="margin-top:10px;margin-left: 20px;">Student ID:</label>
            <?php echo "{$_SESSION['s_id']}"?>
        </br>
        <label style="margin-top:10px;margin-left: 20px;">Email id:</label>
          <?php echo "{$_SESSION['email']}"?>
        </br>
        
         <label style="margin-top:10px;margin-left: 20px;">Department:</label>
            <?php echo "{$_SESSION['dept']}"?>
        </br>
        <label style="margin-top:10px;margin-left: 20px;">Year:</label>
       <?php echo "{$_SESSION['year']}"?>
        </br>
        <label style="margin-top:10px;margin-left: 20px;">Section:</label>
