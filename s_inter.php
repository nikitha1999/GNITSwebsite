...
<div class="row">
  <div class="col-md-3">
    <div class="list-group">
      <a href="s_dash.php" class="list-group-item active" style ="background-color:#3498DB; margin-top: 25px;" >Student</a>
      <a href="s_inter.php" class="list-group-item">Internal Marks</a>
      <a href="#" class="list-group-item">View Time Table</a>
      <a href="#" class="list-group-item">View Class Material</a>
      <a href="s_s_details.php" class="list-group-item">Student Details</a>
      <a href="#" class="list-group-item">View Circulars</a>
      <a href="#" class="list-group-item">Important Links</a>
      <a href="resume.php" class="list-group-item">Resume Development</a>
      <a href="https://drive.google.com/file/d/0B7ujow-fNhN7ZkxXSjBJM1RDQkd6T242TTlULTNEcFVUU29z/view" target="_blank" class="list-group-item">View Attendance</a>
    </div>
  </div>

<div class="col-md-8">
<div class="card" >
      <div class="card-body" style="background-color:#3498DB;color:#ffffff;margin-top: 25px; height: 40px;">
          <label style="margin-top:10px;margin-left: 20px; ">Internal Marks</label>
      </div>

    </div>
  </br>
<div class="card-body">
  <label style="margin-top:5px;margin-left: 20px;">Student Name:</label>
          <?php echo "{$_SESSION['s_name']}"?>
        </br>
          <label style="margin-top:5px;margin-left: 20px;">Student ID:</label>
          <?php echo "{$_SESSION['s_id']}"?>
        </br>
        <label style="margin-top:5px;margin-left: 20px;">Subject 1:</label>
          <?php echo "{$_SESSION['s1']}"?>
        </br>
         <label style="margin-top:5px;margin-left: 20px;">Subject 2:</label>
          <?php echo "{$_SESSION['s2']}"?>
        </br>
         <label style="margin-top:5px;margin-left: 20px;">Subject 3:</label>
          <?php echo "{$_SESSION['s3']}"?>
        </br>
         <label style="margin-top:5px;margin-left: 20px;">Subject 4:</label>
          <?php echo "{$_SESSION['s4']}"?>
        </br>
         <label style="margin-top:5px;margin-left: 20px;">Subject 5:</label>
          <?php echo "{$_SESSION['s5']}"?>
        </br>
