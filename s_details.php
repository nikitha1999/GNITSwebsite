...
?>
    ...
    <tr>
      ...
      <td><a href="edit-user.php?id=<?php echo $row['s_id'];?>" style="color: blue;">Edit</a> |
         <a href="delete-user.php?id=<?php echo $row['s_id'];?>" style="color: blue;">Delete</a>  </td>
    </tr>
   <?php $i++;}} else{
