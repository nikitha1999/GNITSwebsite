...
<div class="row">
  <div class="col-sm-12">
    <div class="row">
      ...
      <a href="s_inter.php"> <h3 class="text-primary"><span class="label label-primary pull-right"></span>Internal Marks </h3></a>
        </div>
      </div>
       <div class="col-md-3">
      ...
      <div class="col-md-3">
        <div class="well" style="margin-left:20px;margin-top:25px; width:270px; height:170px; text-align:center; background-color:green; ">
       <a>   <h3 class="text-primary"><span class="label label-primary pull-right"></span>View Class Material</h3></a>
        </div>
      </div>
     <div class="col-md-3">
        <div class="well" style="margin-left:20px;margin-top:25px; width:270px; height:170px; text-align:center; background-color:black; ">
        <a href="s_s_details.php">  <h3 class="text-primary"><span class="label label-primary pull-right"></span>Student Details</h3></a>
        </div>
      </div>
      </div>
    </div><!--/row-->    
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="well" style="margin-left:20px;margin-top:25px; width:270px; height:170px; text-align:center; background-color:red; ">
         <a> <h3 class="text-primary"><span class="label label-primary pull-right"></span>View Circulars</h3></a>
        </div>
      </div>
       <div class="col-md-3">
        <div class="well" style="margin-left:20px;margin-top:25px; width:270px; height:170px; text-align:center; background-color:orange; ">
      <a>    <h3 class="text-primary"><span class="label label-primary pull-right"></span>Important Links</h3></a>
        </div>
      </div>
      <div class="col-md-3">
        <div class="well" style="margin-left:20px;margin-top:25px; width:270px; height:170px; text-align:center; background-color:cyan; ">
         <a href="resume.php"> <h3 class="text-primary"><span class="label label-primary pull-right"></span>Resume Development</h3></a>
        </div>
      </div>
     <div class="col-md-3">
        <div class="well" style="margin-left:20px;margin-top:25px; width:270px; height:170px; text-align:center; background-color:brown; ">
       <a href="https://drive.google.com/file/d/0B7ujow-fNhN7ZkxXSjBJM1RDQkd6T242TTlULTNEcFVUU29z/view" target="_blank">  <h3 class="text-primary"><span class="label label-primary pull-right"></span>Attendance</h3></a>
        </div>
      </div>
      </div>
    </div><!--/row-->    
