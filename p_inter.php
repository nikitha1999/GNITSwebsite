...
<div class="row">
  <div class="col-md-3">
    <div class="list-group">
     <a href="p_dash.php" class="list-group-item active" style ="background-color:#3498DB; margin-top: 25px;" >Parent</a>
      <a href="p_inter.php" class="list-group-item">Internal Marks</a>
      ...
      <a href="p_s_details.php" class="list-group-item">Student Details</a>
    </div>
  </div>
