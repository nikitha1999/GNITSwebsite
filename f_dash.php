...
<div class="card" >
      <div class="card-body" style="background-color:#3498DB;color:#ffffff;margin-top: 25px; height: 40px;">
          <label style="margin-top:10px;margin-left: 20px; ">Faculty Details</label>
      </div>

    </div>
  </br>
<div class="card-body">
          <label style="margin-top:5px;margin-left: 20px;">Name:</label>
          <?php echo "{$_SESSION['username']}"?>
        </br>
        <label style="margin-top:10px;margin-left: 20px;">Email id:</label>
          <?php echo "{$_SESSION['email']}"?>
        </br>
         <label style="margin-top:10px;margin-left: 20px;">Faculty ID:</label>
            <?php echo "{$_SESSION['id']}"?>
        </br>
         <label style="margin-top:10px;margin-left: 20px;">Department:</label>
            <?php echo "{$_SESSION['department']}"?>
        </br>
        <label style="margin-top:10px;margin-left: 20px;">Mobile No.:</label>
