...
<form class="form-horizontal" method="post" action="regis.php" onsubmit="return formvalidation();">
  <fieldset>
     <label  style="margin-top: 5px; height: 10px; font-size: 20px;margin-left: 10px; ">Student Registration</label>
    <hr>
        <div class="form-group">
      <label for="inputName" class="col-lg-2 control-label">Student Name:</label>
      <div class="col-lg-9">
        <input type="text" class="form-control" name="s_name" id="s_name" placeholder="enter student name..." required>
      </div>
    </div>
     <div class="form-group">
      <label for="inputName" class="col-lg-2 control-label" >Father's Name:</label>
      <div class="col-lg-9">
        <input type="text" class="form-control" name="s_f_name" id="s_f_name" placeholder="enter father's name..." required>
      </div>
    </div>
     <div class="form-group">
    ...
    <div class="form-group">
      <label class="col-lg-2  control-label" name="dept">Department: </label>
      <div class="col-lg-9">
        <div class="radio">
          <label>
            <input type="radio" name="dept" id="dept" value="CSE" checked="">
            CSE</label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" name="dept" id="dept" value="IT">
            IT
          </label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" name="dept" id="dept" value="ECE">
            ECE
          </label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" name="dept" id="dept" value="EEE">
            EEE
          </label>
        </div>
      </div>
    ...
    <div class="form-group">
      <div class="col-lg-10 col-lg-offset-2">
        <button type="reset" name="s_cancel" class="btn btn-default">Cancel</button>
        <button type="submit" name="s_submit" class="btn btn-primary">Submit</button>
      </div>
    </div>
  </fieldset>
</form>
